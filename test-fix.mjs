...
const LEGACY_ENTITY_NAMES = [
  ...
  'ccedil', 'cedil',
  'divide', 'eacute', 'ecirc', 'egrave', 'euml',
...
test('&nbsp missing semicolon',   'travelling at 60&nbspkm/h', 'travelling at 60&nbsp;km/h');
...
test('multiple in one string',    '60&nbspkm/h and a&middotb', '60&nbsp;km/h and a&middot;b');
